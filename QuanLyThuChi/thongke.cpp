...
QVector<lli> ThongKe::LayDuLieuTongThuTheoTuan(QString Username, QString Thang, QString Nam){
    ...
    qry.prepare("SELECT strftime('%d', ThoiGian) AS 'Ngay', MaThuNhap FROM ThongKe WHERE TenChu = :Username AND strftime('%m', ThoiGian) = :Thang AND strftime('%Y', ThoiGian) = :Nam");
...
QVector<lli> ThongKe::LayDuLieuTongChiTheoTuan(QString Username, QString Thang, QString Nam){
    ...
    qry.prepare("SELECT strftime('%d', ThoiGian) AS 'Ngay', MaKhoanChi FROM ThongKe WHERE TenChu = :Username AND strftime('%m', ThoiGian) = :Thang AND strftime('%Y', ThoiGian) = :Nam");
...
QVector<lli> ThongKe::LayDuLieuTongThuTheoNam(QString Username, QString Nam){
    ...
    qry.prepare("SELECT strftime('%m', ThoiGian) AS 'Thang', MaThuNhap FROM ThongKe WHERE TenChu = :Username AND strftime('%Y', ThoiGian) = :Nam");
...
QVector<lli> ThongKe::LayDuLieuTongChiTheoNam(QString Username, QString Nam){
    ...
    qry.prepare("SELECT strftime('%m', ThoiGian) AS 'Thang', MaKhoanChi FROM ThongKe WHERE TenChu = :Username AND strftime('%Y', ThoiGian) = :Nam");
...
QVector<lli> ThongKe::LayDuLieuCanDoiTheoTuan(QString Username, QString Thang, QString Nam){
    ...
    qry.prepare("SELECT strftime('%d', ThoiGian) AS 'Ngay', MaKhoanChi, MaThuNhap FROM ThongKe WHERE TenChu = :Username AND strftime('%m', ThoiGian) = :Thang AND strftime('%Y', ThoiGian) = :Nam");
...
QVector<lli> ThongKe::LayDuLieuCanDoiTheoNam(QString Username, QString Nam){
    ...
    qry.prepare("SELECT strftime('%m', ThoiGian) AS 'Thang', MaKhoanChi, MaThuNhap FROM ThongKe WHERE TenChu = :Username AND strftime('%Y', ThoiGian) = :Nam");
