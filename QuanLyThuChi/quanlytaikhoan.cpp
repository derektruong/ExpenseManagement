...
lli QuanLyTaiKhoan::LaySoDu(QString Username, QString TenTK){
    ...
    if( qry.exec("SELECT SoDu FROM TaiKhoan WHERE TenChu = '"+TenChu+"' AND Ten = '"+TenTaiKhoan+"'") ){
        while ( qry.next() ) {
...
int QuanLyTaiKhoan::LayMaTaiKhoan(QString Username, QString TenTaiKhoan){
    ...
    if( qry.exec("SELECT MaTaiKhoan FROM TaiKhoan WHERE TenChu = '"+TenChu+"' AND Ten = '"+TenTaiKhoan+"'  ") ){
        while ( qry.next() ) {
...
QString QuanLyTaiKhoan::LayLoaiTaiKhoan(QString Username, QString TenTaiKhoan){
    ...
    if( qry.exec("SELECT Loai FROM TaiKhoan WHERE TenChu = '"+TenChu+"' AND Ten = '"+TenTaiKhoan+"' ") ){
        while ( qry.next() ) {
